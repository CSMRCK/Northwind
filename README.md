# Northwind
Northwind.Common A class library project for common types like interfaces, enums,
...
providers.
Northwind.Common.DataContext A class library project for the EF Core database context with
dependencies on specific database providers.
Northwind.Web An ASP.NET Core project for a simple website that uses a
...
Northwind.Mvc An ASP.NET Core project for a complex website that uses the
